...
function c(e) {
  return e !== IDBDatabase.prototype.transaction ||
    ...
    ? (
      ...
      ? function (...t) {
          return e.apply(l(this), t), u(n.get(this));
        }
      : function (...t) {
          return u(e.apply(l(this), t));
        }
    : function (t, ...n) {
        const r = e.call(l(this), t, ...n);
        return o.set(r, t.sort ? t.sort() : [t]), u(r);
      };
}
function d(t) {
  return 'function' == typeof t
    ...
    : (t instanceof IDBTransaction &&
      ...
      (
        e ||
        (e = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
  ...
  return (
    r &&
      a.addEventListener('upgradeneeded', (e) => {
        r(u(a.result), e.oldVersion, e.newVersion, u(a.transaction), e);
      }),
...
export { p as deleteDB, f as openDB, l as unwrap, u as wrap };
export default null;
